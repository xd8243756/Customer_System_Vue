        ...
        <form @submit.prevent="submitform()">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input v-model="form.受理日期" type="date" class="form-control"/>
            </div>
          </div>
            <div class="row mb-3">
                <div class="col-md-6">
...
const emit = defineEmits(['close'])
  ...
  function open(EditedCase) {
    ...
    form.客訴紀錄編號 = EditedCase.客訴紀錄編號;
    form.處理狀態 = payloadStatus;
    form.對應訂單編號 = EditedCase.對應訂單編號;
    form.客戶姓名 = EditedCase.客戶姓名;
    form.客訴類型 = payloadType;
    form.客訴內容 = EditedCase.客訴內容;
    form.案件嚴重度 = EditedCase.案件嚴重度;
    form.受理人員 = EditedCase.受理人員;
    form.案件負責人 = EditedCase.案件負責人;
    form.客訴日期 = EditedCase.客訴日期formatted;
    form.受理日期 = EditedCase.受理日期formatted;
